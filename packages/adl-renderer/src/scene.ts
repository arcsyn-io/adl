...
export interface ElementView extends BaseView { readonly kind:"element"; readonly type:string; readonly description:string|null; readonly geometry:Rect; readonly properties:Readonly<Record<string,string>> }
...
export interface RelationView extends BaseView { readonly kind:"relation"; readonly sourceId:string; readonly targetId:string; readonly type:string|null; readonly connectorKind:ConnectorKind; readonly description:string|null }
...
export interface RenderInput { readonly model:DiagramModel|null; readonly geometry:GeometryInput; readonly state?:RenderState; readonly validation?:ValidationResult; readonly maxLabelLength?:number }
