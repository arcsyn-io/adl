...
import type { ResolvedDiagramStyles, ResolvedElementStyle, ResolvedGroupStyle, ResolvedRelationStyle } from "@adl/stylesheet";
...
export interface GroupView extends BaseView { readonly kind:"group"; readonly memberIds:readonly string[]; readonly geometry:Rect; readonly properties:Readonly<Record<string,string>>; readonly style?:ResolvedGroupStyle }
