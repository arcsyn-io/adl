...
export interface RelationView extends BaseView { readonly kind:"relation"; readonly sourceId:string; readonly targetId:string; readonly type:string|null; readonly description:string|null }
