# Contract: Editor de código ADL

## Purpose

Superfície observável de web code editor para consumidores internos; entradas e resultados são normativos para testes.

## Inputs

- Dados versionados compatíveis com: @adl/parser, @adl/diagnostics, @adl/serializer.
- Revisão quando o resultado puder ficar obsoleto.
- Opções explícitas com defaults documentados.

## Success

- Resultado ok contendo EditingDocument, Decoration, EditorRevision, EditHistory conforme aplicável.
