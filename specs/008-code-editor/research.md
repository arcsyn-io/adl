# Research: Editor de código ADL

## Decision: Technical approach

**Chosen**: CodeMirror 6 e serviço de linguagem fora de React.

**Rationale**: Preserva determinismo, fronteiras e uma API pequena em apps/web-editor/src/features/code-editor. Respeita a direção de dependências: @adl/parser, @adl/diagnostics, @adl/serializer.
