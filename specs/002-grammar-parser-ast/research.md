# Research: Gramática, lexer, parser e AST

## Decision: Technical approach

**Chosen**: parser recursivo descendente guiado por EBNF.

**Rationale**: Preserva determinismo, fronteiras e uma API pequena em packages/adl-parser. Respeita a direção de dependências: @adl/language.
