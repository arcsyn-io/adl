# Quickstart Validation: Gramática, lexer, parser e AST
...
1. Executar `pnpm --filter @adl/parser test`.
...
`docker compose exec workspace bash -lc "pnpm --filter @adl/parser test"`.
