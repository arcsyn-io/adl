# Research: Fronteira futura de IA

## Decision: Technical approach

**Chosen**: interfaces neutras sem chamada externa.

**Rationale**: Preserva determinismo, fronteiras e uma API pequena em packages/adl-ai-contracts. Respeita a direção de dependências: @adl/semantic, @adl/diagnostics, @adl/serializer, @adl/conformance.
