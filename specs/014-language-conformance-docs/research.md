# Research: Conformidade, documentação e exemplos

## Decision: Technical approach

**Chosen**: fixtures JSON e documentação Markdown validada.

**Rationale**: Preserva determinismo, fronteiras e uma API pequena em packages/adl-conformance. Respeita a direção de dependências: features 001–005 e 013.
