# Research: Posicionamento manual

## Decision: Technical approach

**Chosen**: estado visual por identidade e comandos reversíveis.

**Rationale**: Preserva determinismo, fronteiras e uma API pequena em packages/adl-canvas-state. Respeita a direção de dependências: @adl/layout, @adl/workspace, feature 009.
