# Contract: Posicionamento manual

## Purpose

Superfície observável de @adl/canvas-state para consumidores internos; entradas e resultados são normativos para testes.

## Inputs

- Dados versionados compatíveis com: @adl/layout, @adl/workspace, feature 009.
- Revisão quando o resultado puder ficar obsoleto.
- Opções explícitas com defaults documentados.

## Success

- Resultado ok contendo PlacementState, PinnedPlacement, MoveOperation, ViewportState conforme aplicável.
