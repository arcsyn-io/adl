# Research: Serialização canônica da ADL

## Decision: Technical approach

**Chosen**: impressão canônica determinística.

**Rationale**: Preserva determinismo, fronteiras e uma API pequena em packages/adl-serializer. Respeita a direção de dependências: @adl/language, @adl/semantic, @adl/diagnostics.
