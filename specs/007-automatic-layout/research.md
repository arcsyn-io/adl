# Research: Layout automático

## Decision: Technical approach

**Chosen**: ELK encapsulado e saída normalizada.

**Rationale**: Preserva determinismo, fronteiras e uma API pequena em packages/adl-layout. Respeita a direção de dependências: @adl/semantic, @adl/renderer.
