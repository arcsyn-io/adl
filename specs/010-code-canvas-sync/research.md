# Research: Sincronização código-canvas

## Decision: Technical approach

**Chosen**: máquina de estados com origem e revisão.

**Rationale**: Preserva determinismo, fronteiras e uma API pequena em packages/adl-workspace. Respeita a direção de dependências: @adl/serializer e features 008/009.
