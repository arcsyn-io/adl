# Contract: Sincronização código-canvas

## Purpose

Superfície observável de @adl/workspace para consumidores internos; entradas e resultados são normativos para testes.

## Inputs

- Dados versionados compatíveis com: @adl/serializer e features 008/009.
- Revisão quando o resultado puder ficar obsoleto.
- Opções explícitas com defaults documentados.

## Success

- Resultado ok contendo WorkspaceRevision, ChangeOrigin, LastValidSnapshot, Conflict conforme aplicável.
