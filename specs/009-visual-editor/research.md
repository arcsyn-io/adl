# Research: Editor visual de diagramas

## Decision: Technical approach

**Chosen**: command bus reversível independente da UI.

**Rationale**: Preserva determinismo, fronteiras e uma API pequena em apps/web-editor/src/features/visual-editor. Respeita a direção de dependências: @adl/semantic, @adl/diagnostics, @adl/renderer.
