# Research: Importação e exportação

## Decision: Technical approach

**Chosen**: pipeline de I/O orientado a resultados.

**Rationale**: Preserva determinismo, fronteiras e uma API pequena em packages/adl-io. Respeita a direção de dependências: @adl/diagnostics, @adl/serializer, @adl/renderer, @adl/persistence.
