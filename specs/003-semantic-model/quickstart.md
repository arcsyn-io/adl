# Quickstart Validation: Modelo semântico da ADL
...
1. Executar `pnpm --filter @adl/semantic test`.
...
`docker compose exec workspace bash -lc "pnpm --filter @adl/semantic test"`.
