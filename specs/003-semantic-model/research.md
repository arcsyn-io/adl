# Research: Modelo semântico da ADL

## Decision: Technical approach

**Chosen**: pipeline AST para modelo imutável.

**Rationale**: Preserva determinismo, fronteiras e uma API pequena em packages/adl-semantic. Respeita a direção de dependências: @adl/language, @adl/parser.
