# Research: Persistência local

## Decision: Technical approach

**Chosen**: IndexedDB com envelope versionado e gravação atômica.

**Rationale**: Preserva determinismo, fronteiras e uma API pequena em packages/adl-persistence. Respeita a direção de dependências: @adl/serializer, @adl/workspace, @adl/canvas-state.
