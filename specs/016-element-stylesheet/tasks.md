...
- [ ] T036 [P] [US3] Escrever teste E2E do fluxo autocontido e atualização do preview em `tests/e2e/element-stylesheet.spec.ts`
...
- Não adicionar coordenadas ao `.adl` ou `.adls`.
