# Research: Validação semântica e diagnósticos

## Decision: Technical approach

**Chosen**: regras puras e catálogo de códigos.

**Rationale**: Preserva determinismo, fronteiras e uma API pequena em packages/adl-diagnostics. Respeita a direção de dependências: @adl/parser, @adl/semantic.
